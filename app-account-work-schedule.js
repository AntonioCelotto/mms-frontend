(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .accounts-workspace-view{min-height:calc(100vh - 116px);align-content:start;padding:18px;border-radius:8px;background:rgba(255,253,248,.74);box-shadow:inset 0 0 0 1px rgba(30,45,41,.06)}
      .accounts-workspace-view .layout-2{grid-template-columns:1fr!important;width:100%}
      .accounts-workspace-view .surface{width:100%}
      ...
      @media(max-width:1100px){.accounts-workspace-view{padding:14px}.accounts-workspace-view .form-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
      @media(max-width:680px){.accounts-workspace-view{padding:10px}.accounts-workspace-view .form-grid{grid-template-columns:1fr}.accounts-workspace-view .field.span-2{grid-column:span 1}.accounts-workspace-view table{min-width:980px}}
    `;
