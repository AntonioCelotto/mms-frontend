...
for (const script of ["app-calendar-week-navigation.js", "app-calendar-hour-distribution.js"]) {
...
console.log("Calendar intervals for 847 and 848 survive an order detail reload.");
