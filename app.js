...
async function saveDraftOrder() {
  ...
  try {
    ...
    await fetch("/api/save-materials", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ order_id: orderId, materials }),
    });
    ...
    <section class="view ${appState.currentView === "order-detail" ? "active" : ""}">
      <div class="screen-header">
        ...
        <div class="screen-actions">
          ...
          <button class="action-pill" data-action="refresh-order">Aggiorna stato</button>
        </div>
      </div>
                    ...
                    <div class="task-item">
                      ...
                      <div>
                        ...
                        <div class="pill-row">
                          ...
                          ${
                            task.id
                              ? `<button class="mini-btn" data-task-update="${task.id}" data-next-status="${task.state === "Completato" ? "in_corso" : "completato"}">${task.state === "Completato" ? "Riapri" : "Completa"}</button>`
                              : ""
                          }
                        </div>
                      </div>
        ...
        <div class="surface-inner">
          <div class="section-title">
            <div>
              ...
              <p>Assegna un task dell'ordine selezionato a una persona e a un giorno di calendario.</p>
            </div>
          </div>
          <div class="form-grid">
            <div class="field">
              <label>Task ordine #${appState.selectedOrderId}</label>
    ...
    <section class="view ${appState.currentView === "client" ? "active" : ""}">
      <div class="screen-header">
        ...
        <div class="screen-actions">
          ...
          <button class="action-pill" data-action="save-client">${appState.busy ? "Salvataggio..." : "Salva cliente"}</button>
        </div>
      </div>
        ...
        <div class="surface">
          <div class="surface-inner">
            ...
            <div class="profile-lines">
              ...
              <div class="line"><div class="muted">Contatto</div><div><input class="field-value" data-client-field="email" value="${appState.clientDraft.email}" /></div></div>
              <div class="line"><div class="muted">Telefono</div><div><input class="field-value" data-client-field="phone" value="${appState.clientDraft.phone}" /></div></div>
              <div class="line"><div class="muted">Pagamento</div><div><input class="field-value" data-client-field="paymentRule" value="${appState.clientDraft.paymentRule}" /></div></div>
              <div class="line"><div class="muted">Tipologia lavori</div><div>${client.workType}</div></div>
              <div class="line"><div class="muted">Note cliente</div><div><textarea class="field-value" data-client-field="note" style="min-height:86px; align-items:flex-start; padding-top:12px;">${appState.clientDraft.note}</textarea></div></div>
              <div class="line"><div class="muted">Portale cliente</div><div><select class="filter-chip" data-client-field="visibilityEnabled"><option value="true" ${appState.clientDraft.visibilityEnabled ? "selected" : ""}>Attivo</option><option value="false" ${!appState.clientDraft.visibilityEnabled ? "selected" : ""}>Disattivo</option></select></div></div>
            </div>
          </div>
        </div>
    ...
    <section class="view ${appState.currentView === "payments" ? "active" : ""}">
      <div class="screen-header">
        ...
        <div class="screen-actions">
          ...
          <button class="action-pill" data-action="register-payment">${appState.busy ? "Salvataggio..." : "Registra incasso"}</button>
        </div>
      </div>
        ...
        <div class="surface-inner">
          <div class="section-title">
            <div>
              ...
              <p>Utente, ruolo e skill operative che useremo poi anche nelle assegnazioni del calendario.</p>
            </div>
          </div>
          <div class="form-grid">
            <div class="field">
              <label>Nome</label>
              <input class="field-value" data-account-field="first_name" value="${appState.accountDraft.first_name}" />
            </div>
            <div class="field">
              <label>Cognome</label>
              <input class="field-value" data-account-field="last_name" value="${appState.accountDraft.last_name}" />
            </div>
            <div class="field">
              <label>Telefono</label>
              <input class="field-value" data-account-field="phone" value="${appState.accountDraft.phone}" />
            </div>
            <div class="field">
              <label>Email</label>
              <input class="field-value" data-account-field="email" value="${appState.accountDraft.email}" />
            </div>
            <div class="field">
              <label>Ruolo</label>
              <select class="filter-chip" data-account-field="role">
                <option value="viewer" ${appState.accountDraft.role === "viewer" ? "selected" : ""}>Visualizzatore</option>
                <option value="admin" ${appState.accountDraft.role === "admin" ? "selected" : ""}>Amministratore</option>
              </select>
            </div>
            <div class="field span-2">
              <label>Skill</label>
              <input class="field-value" data-account-field="skills" value="${appState.accountDraft.skills}" placeholder="cartamodello, taglio, confezione" />
            </div>
          </div>
        </div>
      </div>
...
function renderNewOrder() {
  ...
  const materialsRows = appState.draftMaterials
    .map(
      (material, index) => `
        <tr>
          <td><input class="field-value" data-material-index="${index}" data-material-field="product_name" value="${material.product_name}" /></td>
          <td>
            <select class="filter-chip" data-material-index="${index}" data-material-field="source_type">
          ...
          <td><input class="field-value" data-material-index="${index}" data-material-field="warehouse_status_note" value="${material.warehouse_status_note}" /></td>
          <td>
            <select class="filter-chip" data-material-index="${index}" data-material-field="delivery_status">
              <option value="consegnato" ${material.delivery_status === "consegnato" ? "selected" : ""}>Consegnato</option>
              <option value="non_consegnato" ${material.delivery_status === "non_consegnato" ? "selected" : ""}>Non consegnato</option>
            </select>
          </td>
          <td><input class="field-value" data-material-index="${index}" data-material-field="preorder_note" value="${material.preorder_note}" /></td>
          <td><button class="mini-btn" data-remove-material="${index}">Rimuovi</button></td>
        </tr>
      `
    )
    .join("");
          ...
          <div class="surface-inner">
            ...
            <div class="form-grid">
              ...
              <div class="field">
                ...
                <div class="field-value">Automatico</div>
              </div>
              <div class="field">
            ...
            <div style="height:16px;"></div>
            <div class="pill-row">
              <button class="mini-btn" data-action="add-material">Aggiungi materiale</button>
              <button class="action-pill" data-action="save-order">${appState.busy ? "Salvataggio..." : "Salva ordine"}</button>
            </div>
          </div>
        </div>
  ...
  return `
    <div class="app-shell">
      ...
      <main class="main">
        ...
        <div class="workspace">
          ${appState.flashMessage ? `<div class="surface"><div class="surface-inner"><strong>${appState.flashMessage}</strong></div></div>` : ""}
          ${renderDashboard()}
          ${renderOrders()}
          ${renderOrderDetail()}
          ${renderCalendar()}
...
function attachEvents() {
  ...
  document.querySelectorAll("[data-material-index]").forEach((input) => {
    const handler = (event) => {
      const index = Number(event.target.dataset.materialIndex);
      const field = event.target.dataset.materialField;
      appState.draftMaterials[index][field] = event.target.value;
    };
  ...
  document.querySelectorAll("[data-remove-material]").forEach((button) => {
    button.addEventListener("click", () => {
      appState.draftMaterials.splice(Number(button.dataset.removeMaterial), 1);
      renderApp();
    });
  });
  ...
  document.querySelectorAll("[data-client-field]").forEach((input) => {
    const handler = (event) => {
      const field = event.target.dataset.clientField;
      appState.clientDraft[field] = field === "visibilityEnabled" ? event.target.value === "true" : event.target.value;
    };
    input.addEventListener("input", handler);
    input.addEventListener("change", handler);
  });
  ...
  document.querySelectorAll("[data-account-field]").forEach((input) => {
    const handler = (event) => {
      appState.accountDraft[event.target.dataset.accountField] = event.target.value;
    };
    input.addEventListener("input", handler);
    input.addEventListener("change", handler);
  });
  ...
  document.querySelectorAll("[data-action='save-order']").forEach((button) => {
    button.addEventListener("click", () => {
      if (!appState.busy) {
        saveDraftOrder();
      }
  ...
  document.querySelectorAll("[data-task-update]").forEach((button) => {
    button.addEventListener("click", () => {
      if (!appState.busy) {
        updateTaskFromUi(Number(button.dataset.taskUpdate), button.dataset.nextStatus);
      }
    });
  });

  document.querySelectorAll("[data-action='refresh-order']").forEach((button) => {
    button.addEventListener("click", async () => {
      if (appState.busy) return;
      setBusy(true);
      try {
        await refreshBootstrap();
        setFlashMessage("Dati ordine aggiornati");
      } catch (error) {
        setFlashMessage("Errore durante l'aggiornamento");
      } finally {
        appState.busy = false;
        renderApp();
      }
  ...
  document.querySelectorAll("[data-action='save-client']").forEach((button) => {
    button.addEventListener("click", () => {
      if (!appState.busy) {
        saveClientDraft();
      }
  ...
  document.querySelectorAll("[data-action='register-payment']").forEach((button) => {
    button.addEventListener("click", () => {
      if (!appState.busy) {
        registerPaymentForSelectedOrder();
      }
    });
  });

  document.querySelectorAll("[data-action='save-account']").forEach((button) => {
    button.addEventListener("click", () => {
      if (!appState.busy) {
        saveAccountDraft();
      }
